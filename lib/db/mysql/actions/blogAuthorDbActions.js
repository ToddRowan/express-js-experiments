...
const bamgen = require('../../mysql/adapters/blogAuthorModelMysqlGenerator');

class blogAuthorDbActions {
  ...
  create(blogAuthorModel) {
    let generator = new bamgen(blogAuthorModel);
...
module.exports = blogAuthorDbActions;