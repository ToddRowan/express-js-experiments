...
class blogPostDbActions {
  ...
  create(blogPostModel) {
    let sql = 'INSERT INTO posts (title, author, content, excerpt, name, guid) VALUES ("title", 1, "this is the post content", "this is the post excerpt", "joe", "guid' + ' ")';
    return new Promise((res, rej) => {
      ...
      this._connection.query(sql, (err, results) => {
        ...
        if (err) {
          ...
          // Prolly oughta return the blogpost model instead.
